...
const Booking = () => {
    ...
    return (
        <div className="container" style={{ padding: '40px 0', display: 'flex', gap: '30px', alignItems: 'flex-start' }}>
            ...
            <div style={{ flex: 7, backgroundColor: '#111', padding: '30px', borderRadius: '12px', border: '1px solid #222' }}>
                ...
                <div style={{ marginTop: '40px', display: 'flex', justifyContent: 'center', gap: '20px', color: '#aaa', fontSize: '0.9rem' }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}><div style={{ width: '16px', height: '16px', backgroundColor: '#333', borderRadius: '4px' }}></div> Ghế trống</div>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}><div style={{ width: '16px', height: '16px', backgroundColor: 'var(--primary-color)', borderRadius: '4px' }}></div> Đang chọn</div>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}><div style={{ width: '16px', height: '16px', backgroundColor: '#222', borderRadius: '4px' }}></div> Đã bán</div>
                </div>
            </div>
            ...
            <div style={{ flex: 3, backgroundColor: '#1a1a1a', padding: '25px', borderRadius: '12px', border: '1px solid #333', position: 'sticky', top: '100px', display: 'flex', flexDirection: 'column', gap: '20px' }}>
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', backgroundColor: '#111', padding: '15px', borderRadius: '8px' }}>
                    ...
                    <span style={{ fontWeight: 'bold', fontSize: '1.2rem', color: '#fff' }}>{selectedSeats.length}</span>
                </div>
